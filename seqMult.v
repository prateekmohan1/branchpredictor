...
//	
//
//  Source file: /afs/asu.edu/users/p/m/o/pmohan6/EEE591Brunhav/ProjPart4/Submission/primitives/seqMult.vp
...
module seqMult (
	...
	//Compute the z_AND to be used later, continuously used
    	...
    	assign z_AND[16] = z[0] & b_flop[16];
    	assign z_AND[17] = z[0] & b_flop[17];
    	assign z_AND[18] = z[0] & b_flop[18];
    	assign z_AND[19] = z[0] & b_flop[19];
    	assign z_AND[20] = z[0] & b_flop[20];
    	assign z_AND[21] = z[0] & b_flop[21];
    	assign z_AND[22] = z[0] & b_flop[22];
    	assign z_AND[23] = z[0] & b_flop[23];
    	assign z_AND[24] = z[0] & b_flop[24];
    	assign z_AND[25] = z[0] & b_flop[25];
    	assign z_AND[26] = z[0] & b_flop[26];
    	assign z_AND[27] = z[0] & b_flop[27];
    	assign z_AND[28] = z[0] & b_flop[28];
    	assign z_AND[29] = z[0] & b_flop[29];
    	assign z_AND[30] = z[0] & b_flop[30];
    	assign z_AND[31] = z[0] & b_flop[31];
